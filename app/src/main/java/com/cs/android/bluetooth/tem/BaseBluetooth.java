package com.cs.android.bluetooth.tem;
...
/**
 * @author ChenSen
 * @desc 客户端连接及服务端监听基类，用于客户端和服务端之间 Socket 消息通讯，进行消息或文件的发送、接收，进行通讯关闭操作等：
 * @since 2022/1/12 9:50
 **/
            ...
            while (isRead) { //循环读取
                switch (in.readInt()) {
                    ...
                    case FLAG_FILE: //读取文件
                        ...
                        long fileLength = in.readLong();   //文件长度
