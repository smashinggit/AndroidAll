...
/**
 * @author ChenSen
 * @since 2021/12/7 9:00
 * @desc kotlin 中 ByteArray 与基本类型的转换工具(位运算)
 *
 *  安卓与硬件通讯过程中(例如：蓝牙，串口等)，经常会遇到ByteArray的解析，
 *  故而依据node.js中Buffer的API编写了ByteArray扩展工具类，解决ByteArray与基本类型转换之间的符号及大小端问题，简单高效。
 *
 *
 *   BIN、OCT、HEX、DEC 分别代表 二、八、十六、十进制
 * 　binary　二进制的
 * 　octal　八进制的
 * 　hexadecimal　十六进制的
 * 　decimal　十进制的
